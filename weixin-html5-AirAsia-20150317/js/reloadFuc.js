...
//            localStorage && localStorage.setItem("timer", a["pv"]), $setCookie("spring_pv", a["pv"], 7200), shaketv.wxShare("http://192.168.1.107:8080/weixin-html5-AirAsia-20150317/image/AirAsia.png", f, g, i)
//        }), $(".p5__print-wrap").on("longTap", function () {
//            localStorage && localStorage.setItem("timer", a["pv"]), $setCookie("spring_pv", a["pv"], 7200), shaketv.wxShare("http://192.168.1.107:8080/weixin-html5-AirAsia-20150317/image/AirAsia.png", f, g, i)
//        })))
//    }}), shaketv.wxShare("http://192.168.1.107:8080/weixin-html5-AirAsia-20150317/image/AirAsia.png", f, g, i)
