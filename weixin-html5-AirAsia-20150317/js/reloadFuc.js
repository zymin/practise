/**
 * Created by eyestone001 on 2014/12/22.
 */
...
$(document).ready(function () {
    ...
    b && 3 > d ? head.load("css/icon.css", function () {
        ...
        a.onload = function () {
            ...
            var a, b;
            $(".loading-wrap").css("display", "none"), a = document.querySelector("audio"), a.oncanplay = c(), b = 0, $(".speaker").css("display", "block"), head.load( "css/p6.css", function () {
                var a = preImg(".share-guide");
                a.onload = function () {
                    $(".share-mask").css("display", "none")
                }
...
//            localStorage && localStorage.setItem("timer", a["pv"]), $setCookie("spring_pv", a["pv"], 7200), shaketv.wxShare("http://192.168.1.107:8080/weixin-html5-AirAsia-20150317/images/AirAsia.png", f, g, i)
//        }), $(".p5__print-wrap").on("longTap", function () {
//            localStorage && localStorage.setItem("timer", a["pv"]), $setCookie("spring_pv", a["pv"], 7200), shaketv.wxShare("http://192.168.1.107:8080/weixin-html5-AirAsia-20150317/images/AirAsia.png", f, g, i)
//        })))
//    }}), shaketv.wxShare("http://192.168.1.107:8080/weixin-html5-AirAsia-20150317/images/AirAsia.png", f, g, i)
