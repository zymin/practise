...
(function (global) {
    ...
    Ta.hack = function () {
        return {
            params: '',
            conf: {sid: 38454478, pf: 1, logo: 255, hot: {}}        };
    };
})(this);
...
(function (g, n) {
    ...
    function q(c, a, b) {
        ...
        var d = {"com.cn": 1, "net.cn": 1, "gov.cn": 1, "com.hk": 1, "co.nz": 1, "org.cn": 1, "edu.cn": 1}, e = a.split(".");
    ...
    function C(c) {
        var a = {9: "\u817e\u8baf\u5206\u6790", 10: "\u7f51\u7ad9\u7edf\u8ba1", df: '<images src="' + (("https:" == document.location.protocol ? "https:" : "http:") + "//tajs.qq.com/icon/toss_" + c + ".gif") + '" border="0" />'};
        document.write(['<a href="http://ta.qq.com?ADTAG=FROUM.FOOTER.CLICK.ICON" title="\u817e\u8baf\u5206\u6790" target="_blank">', a[c] || a.df, "</a>"].join(""))
    }

    var k = {afs: {key: 1,
        id: "ssid", c_id: "pgv_afsid", fr: "hash"}, afc: {key: 2, id: "__tacid", c_id: "pgv_afcid", fr: "param"}, gdt: {key: 11, id: "qz_gdt", c_id: "pgv_gdtid", fr: "param"}};
    n.pgvSendClick = u;
    n.taClick = u;
    n.Ta = n.Ta || {};
    Ta.pgv = t;
